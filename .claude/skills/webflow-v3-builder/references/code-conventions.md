...
4. **Structure**: full-bleed outer box (background, vertical padding) wrapping an inner content box (gutters, future max-width). Slot children land in the inner box.
